...
export function buildJsonLd() {
  ...
  const breadcrumb = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Início", item: PREVIEW_URL },
      { "@type": "ListItem", position: 2, name: "Quem somos", item: `${PREVIEW_URL}/quem-somos` },
      { "@type": "ListItem", position: 3, name: "Produtos", item: `${PREVIEW_URL}/produtos` },
      { "@type": "ListItem", position: 4, name: "Atacado", item: `${PREVIEW_URL}/atacado` },
      { "@type": "ListItem", position: 5, name: "Galeria", item: `${PREVIEW_URL}/galeria` },
      { "@type": "ListItem", position: 6, name: "Mundo Rebeka", item: `${PREVIEW_URL}/mundo-rebeka` },
      { "@type": "ListItem", position: 7, name: "Contato", item: `${PREVIEW_URL}/contato` },
      { "@type": "ListItem", position: 8, name: "Dúvidas", item: `${PREVIEW_URL}/duvidas` },
      { "@type": "ListItem", position: 9, name: "Catálogo", item: `${PREVIEW_URL}/catalogo` },
    ],
  };
