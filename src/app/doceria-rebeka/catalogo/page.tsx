...
import { PRODUCTS, SITE, WA, WA_CATALOG } from "../data";
import "../rebeka.css";

export default function CatalogoPage() {
  return (
    <div className="rbk-clone min-h-screen bg-background">
      <div className="rbk-catalog">
        <p className="eyebrow">Catálogo atacado</p>
        <h1 className="mt-3">Doceria da Rebeka</h1>
        <p className="mt-3 text-muted-foreground text-lg max-w-2xl">
          Pudim e brigadeirão para mercados e distribuidores. Fábrica em São José dos Campos, presença nacional no
          atacado.
        </p>
        ...
        <div className="rbk-catalog-actions">
          ...
          <Link href="/doceria-rebeka" className="btn-outline">
            Voltar ao site
          </Link>
        </div>
